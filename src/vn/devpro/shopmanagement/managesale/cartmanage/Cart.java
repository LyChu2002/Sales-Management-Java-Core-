package vn.devpro.shopmanagement.managesale.cartmanage;
...
public class Cart {
	...
	public void display() {
		...
		for(int i=0; i<listProduct.size(); i++) {
			...
			System.out.printf("%3d %4s %-30s %9s %10.2f%n", stt++, listProduct.get(i), product.getName(), productList.getAmount(), product.getPrice());
		}
