package vn.devpro.shopmanagement.update.typeupdate;
...
public class TypeManagement {
	...
	public static void init() {
		list.add(new Type(autoId++, "Ao cong so", "Danh cho nam"));
		list.add(new Type(autoId++, "Ao thun", "Co dan, khong nhan"));
		list.add(new Type(autoId++, "Vay hoa", "Phong cach hien dai"));
		list.add(new Type(autoId++, "Mu", "Nhieu kieu dang"));
		list.add(new Type(autoId++, "Tui xach", "Da bong"));
	}
	...
	private static void add() {
		System.out.println("--------------Them chung loai------------------");
	...
	private static void update() {
		System.out.println("--------------Cap nhat thong tin chung loai-------------");
	...
	private static void remove() {
		System.out.println("----------------Xoa chung loai-------------------");
		System.out.print("Nhap id chung loai: ");
		int id = Integer.parseInt(sc.nextLine());
		int index = findTypeById(id);
		if(index == -1) {
