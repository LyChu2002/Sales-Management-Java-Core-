package vn.devpro.shopmanagement.update.productupdate;
...
public class ProductManagement {
	...
	public static void init() {
		list.add(new Product(autoId++, 1, 1, "Ao so mi", 30, 300000));
		list.add(new Product(autoId++, 1, 2, "Ao polo", 120, 150000));
		list.add(new Product(autoId++, 3, 2, "Ao phong nu", 80, 100000));
		list.add(new Product(autoId++, 5, 3, "Vay hoa co vien", 10, 250000));
		list.add(new Product(autoId++, 2, 4, "Mu luoi trai", 100, 80000));
		list.add(new Product(autoId++, 4, 1, "Vest cong so", 22, 600000));
		list.add(new Product(autoId++, 3, 5, "Tui deo cheo", 20, 400000));
		list.add(new Product(autoId++, 5, 2, "Ao phong nam", 36, 110000));
	}
	private static void display() {
		System.out.println("----------------Danh sach san pham--------------------");
		System.out.printf("%-4s %-25s %-20s %-30s %-8s %-9s%n", "ID", "Ten nha cung cap", "Ten loai", "Ten san pham", "So luong", "Don gia");
		for(Product x : list) {
			x.display();
		}
	}
