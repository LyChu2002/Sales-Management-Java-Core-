...
import vn.devpro.shopmanagement.update.providerupdate.Provider;
import vn.devpro.shopmanagement.update.providerupdate.ProviderManagement;
import vn.devpro.shopmanagement.update.typeupdate.Type;
...
public class Product {
	...
	public void display() {
		...
		System.out.printf("%4d %-25s %-20s %-30s %8d %9.2f%n", this.id, provider.getName(), type.getName(), this.getName(), this.amount, this.price);
	}
