package vn.devpro.shopmanagement.update.providerupdate;
...
public class ProviderManagement {
	...
	public static void init() {
		list.add(new Provider(autoId++, "Ha Hai", "Ha Noi"));
		list.add(new Provider(autoId++, "May Phuong Thao", "Da Nang"));
		list.add(new Provider(autoId++, "Hoang Mai", "Hai Duong"));
		list.add(new Provider(autoId++, "May Viettx", "TP. Ho Chi Minh"));
		list.add(new Provider(autoId++, "An Thang", "Hai Duong"));
	}
