package vn.devpro.shopmanagement.update.customerupdate;
...
public class CustomerManagement {
	...
	public static void init() {
		list.add(new Customer(autoId++, "Nguyen Van Cuong", "098643545"));
		list.add(new Customer(autoId++, "Tran Thu Trang", "098247576"));
		list.add(new Customer(autoId++, "Pham Thi Tuyen", "087725478"));
		list.add(new Customer(autoId++, "Tran Van Quyet", "098726466"));
	}
